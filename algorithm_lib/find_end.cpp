...
std::vector<int> seq{{1, 7}};

auto showRes(auto res, int& val, const char* c){
   std::string line("\n :::::::::::::::::::::::::::::::::::::::::::::::\n\033[0m");
   if(res != nums.end()){
       std::cout << "\033[1;" << c << "m" << line << "  Last sequence found at " << val << "\033[1;" << c << "m" << line << std::endl;
   } else {
...
auto main() -> int{
    ...
    int query = 5;
    auto res = std::find_end(nums.begin(), nums.end(), seq.begin(), seq.end());
    ...
    seq = {7, 0};
    res = std::find_end(nums.begin(), nums.end(), seq.begin(), seq.end());
